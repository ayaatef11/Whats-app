...
{
    public class MessageHub(IMapper _mapper, IUnitOfWork _unitOfWork, IHubContext<PresenceHub> _presenceHub,
        PresenceTracker _tracker) : Hub
    {
